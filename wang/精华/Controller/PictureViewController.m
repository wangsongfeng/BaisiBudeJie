...
-(void)getNewData
{
    ...
    [self.Tool getDataWithArrayType:TopicTypePicture parameaterA:@"newlist" block:^(id json, id param) {
...
-(void)getMoreData{
    ...
    kWeakSelf;
    [self.Tool getDataWithMaxtime:self.maxtime page:@(page) TopicType:TopicTypePicture parameterA:@"newlist" block:^(id json, id param) {
