...
-(void)getNewData
{
    ...
    [self.Tool getDataWithArrayType:TopicTypeTalk parameaterA:@"newlist" block:^(id json, id param) {
...
-(void)getMoreData{
    ...
    kWeakSelf;
    [self.Tool getDataWithMaxtime:self.maxtime page:@(page) TopicType:TopicTypeTalk parameterA:@"newlist" block:^(id json, id param) {
